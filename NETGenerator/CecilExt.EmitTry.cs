...
namespace PascalABCCompiler
{
	...
	{
		private readonly Instruction startsAfter;
		...
		{
			Instruction tryStart = startsAfter.Next;
			Instruction tryEnd;
		...
		public ExceptionBlock(Instruction startsAfter)
		{
	...
	internal static partial class CecilExt
	{
		...
		{
			var v = new ExceptionBlock( il.Body.Instructions.Last() );
