    ...
    public class ILConverter : AbstractVisitor
    {
        ...
        private Mono.Cecil.MethodDefinition FileOfAttributeConstructor
        {
            get
            {
                ...
                var tb = new Mono.Cecil.TypeDefinition(ns, className, TypeAttributes.Public | TypeAttributes.BeforeFieldInit, TypeFactory.AttributeType);
                mb.Types.Add(tb);
                types.Add(tb);

                fileOfAttributeConstructor = new Mono.Cecil.MethodDefinition(".ctor", MethodAttributes.Public | Mono.Cecil.MethodAttributes.SpecialName | Mono.Cecil.MethodAttributes.RTSpecialName, mb.TypeSystem.Void);
        ...
        public void ConvertFromTree(SemanticTree.IProgramNode p, string TargetFileName, string SourceFileName, CompilerOptions options, string[] ResourceFiles)
        {
            ...
            {
                var customAttr = new Mono.Cecil.CustomAttribute(TypeFactory.DebuggableAttributeCtor, new byte[] { 0x01, 0x00, 0x01, 0x01, 0x00, 0x00 });
            ...
            if (comp_opt.target != TargetType.Dll)
            {
                entry_type = new Mono.Cecil.TypeDefinition(cur_unit, "Program", TypeAttributes.Public);
            ...
            for (int iii = 0; iii < cnns.Length; iii++)
            {
                ...
                if (!is_main_namespace)
                {
                    ...
                    cur_type = new Mono.Cecil.TypeDefinition(cnnsnamespace_name, cnns[iii].namespace_name, TypeAttributes.Public);
                    ...
                    if (cnns[iii].IsMain)
                    {   // SSM 05.02.20 here change
                        var attr_class = new Mono.Cecil.TypeDefinition(cnnsnamespace_name, "$GlobAttr", TypeAttributes.Public | TypeAttributes.BeforeFieldInit, TypeFactory.AttributeType);
                    ...
                    {
                        var attr_class = new Mono.Cecil.TypeDefinition(cnnsnamespace_name, "$ClassUnitAttr", TypeAttributes.Public | TypeAttributes.BeforeFieldInit, TypeFactory.AttributeType);
                        mb.Types.Add(attr_class);
            ...
            { //ne osobo vazhnaja vesh, sohranjaet v exe-shnik spisok ispolzuemyh prostranstv imen, dlja strahovki obernuli try catch
                ...
                if (comp_opt.dbg_attrs == DebugAttributes.ForDebugging)
                {
                    ...
                    var attr_class = new Mono.Cecil.TypeDefinition("", "$UsedNsAttr", TypeAttributes.Public | TypeAttributes.BeforeFieldInit, TypeFactory.AttributeType);
                    mb.Types.Add(attr_class);
            ...
            if (an.Name == "PABCRtl")
            {
                ...
                CustomAttributeBuilder cab = CustomAttributeBuilder
                    .GetInstance(TypeFactory.AssemblyKeyFileAttributeCtor)
                ...
                cab = CustomAttributeBuilder
                    .GetInstance(TypeFactory.AssemblyDelaySignAttributeCtor)
                    .AddConstructorArgs(new object[] { true });

                ab.CustomAttributes.Add(cab.Build());

                cab = CustomAttributeBuilder
                    .GetInstance(TypeFactory.TargetFrameworkAttributeCtor)
            ...
            var cab2 = CustomAttributeBuilder
                .GetInstance(TypeFactory.SecurityRulesAttributeCtor)
                .AddConstructorArgs(new object[] { SecurityRuleSet.Level2 })
                .AddPropertyArgs(
                    new Mono.Cecil.PropertyReference[] { TypeFactory.SecurityRulesAttributeSkipVerificationInFullTrustProperty },
                    new object[] { true }
                );
            ...
            if (entry_meth != null && comp_opt.target == TargetType.WinExe)
            {
                entry_meth.CustomAttributes.Add(
                    new Mono.Cecil.CustomAttribute(TypeFactory.STAThreadAttributeCtor, new byte[] { 0x01, 0x00, 0x00, 0x00 })
                );
            }
            ...
            ab.CustomAttributes.Add(
                new Mono.Cecil.CustomAttribute(TypeFactory.CompilationRelaxationsAttributeCtor, new byte[] { 0x01, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00 })
            );

            cab2 = CustomAttributeBuilder
                .GetInstance(TypeFactory.AssemblyTitleAttributeCtor)
            ...
            cab2 = CustomAttributeBuilder
                .GetInstance(TypeFactory.AssemblyDescriptionAttributeCtor)
            ...
            for (int i = 0; i < funcs.Length; i++)
            {
                ...
                if (statements.Length > 0 && statements[0] is IExternalStatementNode)
                {
                    ...
                    methb.PInvokeInfo = new Mono.Cecil.PInvokeInfo(
                        Mono.Cecil.PInvokeAttributes.CallConvWinapi | PInvokeAttributes.CharSetAnsi | PInvokeAttributes.BestFitDisabled,
                        esn.name,
        ...
        private Frame MakeAuxType(ICommonFunctionNode func)
        {
            ...
            if (funcs.Count > 0)
            {
                cb = new Mono.Cecil.MethodDefinition(".ctor", MethodAttributes.Public | MethodAttributes.SpecialName | Mono.Cecil.MethodAttributes.RTSpecialName | Mono.Cecil.MethodAttributes.HideBySig, this.mb.TypeSystem.Void);
            ...
            for (int i = 0; i < parameters.Length; i++)
            {
                ...
                if (parameters[i].is_params)
                    pb.CustomAttributes.Add(
                        new Mono.Cecil.CustomAttribute(TypeFactory.ParamArrayAttributeCtor,
        ...
        private MethInfo ConvertCtorWithNested(SemanticTree.ICommonMethodNode meth, Mono.Cecil.MethodDefinition methodb)
        {
            ...
            for (int i = 0; i < parameters.Length; i++)
            {
                ...
                pb.Name = parameters[i].name;
                if (parameters[i].is_params)
                    pb.CustomAttributes.Add(new CustomAttributeBuilder(TypeFactory.ParamArrayAttributeCtor, new byte[] { 0x1, 0x0, 0x0, 0x0 }).Build());
                Mono.Cecil.FieldDefinition fb = null;
                if (parameters[i].parameter_type == parameter_type.value)
                {
                    fb = new Mono.Cecil.FieldDefinition(parameters[i].name, Mono.Cecil.FieldAttributes.Public, param_types[i + num]);
        ...
        private void ConvertNestedInMethodFunctionHeader(ICommonNestedInFunctionFunctionNode func, Mono.Cecil.TypeReference decl_type)
        {
            ...
            for (int i = 0; i < parameters.Length; i++)
            {
                ...
                if (parameters[i].is_params)
                {
                    var customAttr = new Mono.Cecil.CustomAttribute(TypeFactory.ParamArrayAttributeCtor, new byte[] { 0x1, 0x0, 0x0, 0x0 });
        ...
        private void ConvertExternalMethod(SemanticTree.ICommonMethodNode meth)
        {
            ...
            if (statements[0] is IExternalStatementNode)
            {
                ...
                cur_type.Methods.Add(methb);
                methb.PInvokeInfo = new Mono.Cecil.PInvokeInfo(PInvokeAttributes.CallConvWinapi, esn.name, new Mono.Cecil.ModuleReference(module_name));
        ...
        private void ConvertMethodParameters(ICommonMethodNode value, Mono.Cecil.MethodDefinition methb)
        {
            ...
            for (int i = 0; i < parameters.Length; i++)
            {
                ...
                if (parameters[i].is_params)
                    pb.CustomAttributes.Add(
                        new Mono.Cecil.CustomAttribute(TypeFactory.ParamArrayAttributeCtor, new byte[] { 0x1, 0x0, 0x0, 0x0 })
                    );
            }
        }
        ...
        private void AssignToDereferenceNode(IExpressionNode to, IExpressionNode from)
        {
            ...
            if ((from.type.is_value_type || from.type.is_generic_parameter) && 
                ...
                (ctn2.compiled_type.FullName == mb.TypeSystem.Object.FullName || ctn2.compiled_type.Resolve().IsInterface))
               )
            {
                il.Emit(OpCodes.Box, helper.GetTypeReference(from.type).tp);
            }
            else if (from.conversion_type != null && (from.conversion_type.is_value_type || from.conversion_type.is_generic_parameter) && ctn2 != null && (ctn2.compiled_type.FullName == mb.TypeSystem.Object.FullName || ctn2.compiled_type.Resolve().IsInterface))
            {
                il.Emit(OpCodes.Box, helper.GetTypeReference(from.conversion_type).tp);
            }
            CheckArrayAssign(to, from, il);
                ...
                if (real_parameters.Length > 1)
                {
                    if (real_parameters[0].type.is_nullable_type && real_parameters[1] is INullConstantNode)
                    {
                        ...
                        else
                        {
                            ...
                            Mono.Cecil.MethodReference mi = null;
                            mi = TypeFactory.NullableHasValueGetMethod.AsMemberOf((Mono.Cecil.GenericInstanceType)ti.tp);
                            il.Emit(OpCodes.Call, mi);
                        }
                    ...
                    else if (real_parameters[1].type.is_nullable_type && real_parameters[0] is INullConstantNode)
                    {
                        ...
                        else
                        {
							...
							il.Emit(OpCodes.Stloc, tmp_lb);
                            il.Emit(OpCodes.Ldloca, tmp_lb);
                            Mono.Cecil.MethodReference mi = TypeFactory.NullableHasValueGetMethod.AsMemberOf((Mono.Cecil.GenericInstanceType)ti.tp);
                            il.Emit(OpCodes.Call, mi);
                        }
                        if (ft == basic_function_type.objeq)
                        {
                    ...
                    else if (real_parameters[0].type.is_nullable_type && real_parameters[1].type.is_nullable_type)
                    {
                        ...
                        if (!(real_parameters[0] is IDefaultOperatorNode) && !(real_parameters[1] is IDefaultOperatorNode))
                        {
                            ...
                            mi_left = TypeFactory.NullableHasValueGetMethod.AsMemberOf((Mono.Cecil.GenericInstanceType)ti_left.tp);
                            ...
                            mi_right = TypeFactory.NullableHasValueGetMethod.AsMemberOf((Mono.Cecil.GenericInstanceType)ti_right.tp);
                        ...
                        else
                        {
                            ...
                            {
                                mi_left = TypeFactory.NullableGetValueOrDefaultMethod.AsMemberOf((Mono.Cecil.GenericInstanceType)ti_left.tp);
                            }
                        ...
                        else
                        {
                            ...
                            {
                                mi_right = TypeFactory.NullableGetValueOrDefaultMethod.AsMemberOf((Mono.Cecil.GenericInstanceType)ti_right.tp);
                            }
        ...
        public void ConvertGenericParamCtorCall(ICommonConstructorCall value)
        {
            ...
            Mono.Cecil.GenericInstanceMethod create_inst = new Mono.Cecil.GenericInstanceMethod(TypeFactory.ActivatorCreateInstanceMethod);
        ...
        public override void visit(IDoubleQuestionColonExpressionNode value)
        {
            ...
            else
            {
                ...
                if (value.condition.type.is_nullable_type)
                {
                    ...
                    mi = TypeFactory.NullableHasValueGetMethod.AsMemberOf((Mono.Cecil.GenericInstanceType)cond_ti.tp);
                    il.Emit(OpCodes.Call, mi);
                    il.Emit(OpCodes.Ldc_I4_0);
                    il.Emit(OpCodes.Ceq);
                }
        ...
        private void ConvertRangedSelectors(ISwitchNode value, Label end_label, Mono.Cecil.Cil.VariableDefinition lb)
        {
            foreach (ICaseVariantNode cvn in value.case_variants)
            {
        ...
        private void PushRuntimeSize(Mono.Cecil.TypeReference t)
        {
            ...
            else
            {
                ...
                il.Emit(OpCodes.Call, TypeFactory.MarshalSizeOfMethod);
            }
            return;
        }
        ...
        private void emit_conversion(Mono.Cecil.TypeReference t)
        {
            ...
            {
                case Mono.Cecil.MetadataType.Byte: il.Emit(OpCodes.Call, TypeFactory.ConvertToByteMethod); break;
                case Mono.Cecil.MetadataType.SByte: il.Emit(OpCodes.Call, TypeFactory.ConvertToSByteMethod); break;
                case Mono.Cecil.MetadataType.Int16: il.Emit(OpCodes.Call, TypeFactory.ConvertToInt16Method); break;
                case Mono.Cecil.MetadataType.UInt16: il.Emit(OpCodes.Call, TypeFactory.ConvertToUInt16Method); break;
                case Mono.Cecil.MetadataType.Int32: il.Emit(OpCodes.Call, TypeFactory.ConvertToInt32Method); break;
                case Mono.Cecil.MetadataType.UInt32: il.Emit(OpCodes.Call, TypeFactory.ConvertToUInt32Method); break;
                case Mono.Cecil.MetadataType.Int64: il.Emit(OpCodes.Call, TypeFactory.ConvertToInt64Method); break;
                case Mono.Cecil.MetadataType.UInt64: il.Emit(OpCodes.Call, TypeFactory.ConvertToUInt64Method); break;
                case Mono.Cecil.MetadataType.Char: il.Emit(OpCodes.Call, TypeFactory.ConvertToCharMethod); break;
                case Mono.Cecil.MetadataType.Boolean: il.Emit(OpCodes.Call, TypeFactory.ConvertToBooleanMethod); break;
                case Mono.Cecil.MetadataType.Double: il.Emit(OpCodes.Call, TypeFactory.ConvertToDoubleMethod); break;
                case Mono.Cecil.MetadataType.Single: il.Emit(OpCodes.Call, TypeFactory.ConvertToSingleMethod); break;
        ...
        public override void visit(IForeachNode value)
        {
            ...
            if (is_generic)
            {
                var genericMethod = TypeFactory.IEnumerableGenericGetEnumeratorMethod;
